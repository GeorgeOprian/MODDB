            ...
            return paidRents.map((paidRent: PayRentType) => {
                return {
                    value: {
                        adresaApartament: {
                          align: "left",
                          value: `${paidRent.Contract.Apartament.Adresa?.strada}, ${paidRent.Contract.Apartament.Adresa?.numar}, ${paidRent.Contract.Apartament.Adresa?.bloc}, ${paidRent.Contract.Apartament.Adresa?.scara}, ${paidRent.Contract.Apartament.Adresa?.numarApartament}, ${paidRent.Contract.Apartament.Adresa?.Localitate.nume}, 
                          ${paidRent.Contract.Apartament.Adresa?.Localitate.Judet.nume}`
                        },
                        client: {
                            value: `${paidRent.Contract.Chiria.nume} ${paidRent.Contract.Chiria.prenume}`
                        },
                        suma: {
                          value: paidRent.suma
                        },
                        ...
                        idChirias: {
                          value: paidRent.Contract.Chiria.idChirias,
                          hideCell: true
                        },
                        idPlata: {
                        ...
                        idContract: {
                          value: paidRent.Contract.idContract,
                          hideCell: true
                        },
                        dataEfectuarii: {
                        ...
                        incasari: {
                            value: paidRent.Contract.incasari,
                            hideCell: true
                        }
                    }
                }
