...
const PayRentPanel = ({
    ...
    useEffect(
        () => {
            ...
            setPayRentField({
                ...payRentFields,
                suma: editPayRent ? editPayRent.suma : (payRentFields.contract as any).ApartamentProvincie.pretInchiriere
            })
        },
        [payRentFields.contract]
    )
    const getApartmentFullAddress = (contract: any) => {
        return `${contract.ApartamentProvincie.AdresaProvincie.strada}, ${contract.ApartamentProvincie.AdresaProvincie.numar}, ${contract.ApartamentProvincie.AdresaProvincie.bloc}, ${contract.ApartamentProvincie.AdresaProvincie.scara}, ${contract.ApartamentProvincie.AdresaProvincie.numarApartament}, ${contract.ApartamentProvincie.AdresaProvincie.LocalitateProvincie.nume}, ${contract.ApartamentProvincie.AdresaProvincie.LocalitateProvincie.JudetProvincie.nume}`
    }
