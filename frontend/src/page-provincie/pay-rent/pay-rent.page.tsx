...
export type PayRentType = {
    ...
    ContractProvincie: ContractType
}

const PayRentProvinciePage = observer(() => {
            ...
            return paidRents.map((paidRent: PayRentType) => {
                return {
                    value: {
                        adresaApartament: {
                          align: "left",
                          value: `${paidRent.ContractProvincie.ApartamentProvincie.AdresaProvincie?.strada}, ${paidRent.ContractProvincie.ApartamentProvincie.AdresaProvincie?.numar}, ${paidRent.ContractProvincie.ApartamentProvincie.AdresaProvincie?.bloc}, ${paidRent.ContractProvincie.ApartamentProvincie.AdresaProvincie?.scara}, ${paidRent.ContractProvincie.ApartamentProvincie.AdresaProvincie?.numarApartament}, ${paidRent.ContractProvincie.ApartamentProvincie.AdresaProvincie?.LocalitateProvincie.nume}, 
                          ${paidRent.ContractProvincie.ApartamentProvincie.AdresaProvincie?.LocalitateProvincie.JudetProvincie.nume}`
                        },
                        client: {
                            value: `${paidRent.ContractProvincie.ChiriasProvincie.nume} ${paidRent.ContractProvincie.ChiriasProvincie.prenume}`
                        },
                        suma: {
                          value: paidRent.suma
                        },
                        ...
                        idChirias: {
                          value: paidRent.ContractProvincie.ChiriasProvincie.idChirias,
                          hideCell: true
                        },
                        idPlata: {
                        ...
                        idContract: {
                          value: paidRent.ContractProvincie.idContract,
                          hideCell: true
                        },
                        dataEfectuarii: {
                        ...
                        incasari: {
                            value: paidRent.ContractProvincie.incasari,
                            hideCell: true
                        }
                    }
                }
...
export default PayRentProvinciePage;