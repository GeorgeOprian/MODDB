...
const RentPanel = ({
    ...
    const getApartmentFullAddress = (apartment: any) => {
        return `${apartment.AdresaProvincie.strada}, ${apartment.AdresaProvincie.numar}, ${apartment.AdresaProvincie.bloc}, ${apartment.AdresaProvincie.scara}, ${apartment.AdresaProvincie.numarApartament}, ${apartment.AdresaProvincie.LocalitateProvincie.nume}, ${apartment.AdresaProvincie.LocalitateProvincie.JudetProvincie.nume}`
    }
