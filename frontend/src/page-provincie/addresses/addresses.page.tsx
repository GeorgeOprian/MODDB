...
export type AddressType = {
    ...
    scara: string,
    strada: string,
    LocalitateProvincie: LocalitateType
}
...
const  AdressesProvinciePage = observer(() => {
        ...
        return addresses.map(address => {
            return {
                value: {
                    ...
                    localitate: {
                      value: address.LocalitateProvincie.nume
                    },
                    judet: {
                      value: address.LocalitateProvincie.JudetProvincie.nume
                    },
                    idLocalitate: {
                      value: address.LocalitateProvincie.idLocalitate,
                      hideCell: true
                    },
                    idAdresa: {
...
export default AdressesProvinciePage;