...
const ApartmentPanel = ({
    ...
    const getFullAddress = (address: any) => {
        return `${address.strada}, ${address.numar}, ${address.bloc}, ${address.scara}, ${address.numarApartament}, ${address.LocalitateProvincie.nume}, ${address.LocalitateProvincie.JudetProvincie.nume}`
    }
