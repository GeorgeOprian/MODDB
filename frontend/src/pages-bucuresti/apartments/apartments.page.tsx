...
export type ApartmentType = {
    ...
    tipConfort: number,
    ID_ADRESA: number,
    AdresaBucuresti?: AddressType
}

const  ApartmentsBucurestiPage = observer(() => {
        ...
        return apartments.map((apartment: ApartmentType) => {
            return {
                value: {
                    ...
                    adresa: {
                      value: `${apartment.AdresaBucuresti?.strada}, ${apartment.AdresaBucuresti?.numar}, ${apartment.AdresaBucuresti?.bloc}, ${apartment.AdresaBucuresti?.scara}, ${apartment.AdresaBucuresti?.numarApartament}, ${apartment.AdresaBucuresti?.LocalitateBucuresti.nume}, ${apartment.AdresaBucuresti?.LocalitateBucuresti.JudetBucuresti.nume}`
                    },
                    centralaProprie: {
...
export default ApartmentsBucurestiPage;