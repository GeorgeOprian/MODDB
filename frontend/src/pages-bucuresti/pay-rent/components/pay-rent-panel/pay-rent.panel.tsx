...
const PayRentPanel = ({
    ...
    useEffect(
        () => {
            ...
            setPayRentField({
                ...payRentFields,
                suma: editPayRent ? editPayRent.suma : (payRentFields.contract as any).ApartamentBucuresti.pretInchiriere
            })
        },
        [payRentFields.contract]
    )
    const getApartmentFullAddress = (contract: any) => {
        return `${contract.ApartamentBucuresti.AdresaBucuresti.strada}, ${contract.ApartamentBucuresti.AdresaBucuresti.numar}, ${contract.ApartamentBucuresti.AdresaBucuresti.bloc}, ${contract.ApartamentBucuresti.AdresaBucuresti.scara}, ${contract.ApartamentBucuresti.AdresaBucuresti.numarApartament}, ${contract.ApartamentBucuresti.AdresaBucuresti.LocalitateBucuresti.nume}, ${contract.ApartamentBucuresti.AdresaBucuresti.LocalitateBucuresti.JudetBucuresti.nume}`
    }
